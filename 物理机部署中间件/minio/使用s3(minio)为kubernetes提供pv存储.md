...
#### 2.1、创建一个secrets用来提供minio的凭据(csi-driver-s3-secret.yaml)
...
#### 2.3、创建storageclass （storageclass.yaml）
...
s3backer目前处于试验阶段，因为在Kubernetes节点或CSI Pod意外关闭的情况下，卷损坏可能很快发生。s3backer二进制文件未与普通docker映像捆绑在一起，以使其尽可能小。使用`<version>-full`image标签测试s3backer



### 三、使用

#### 3.1、创建一个pvc并创建一个pod绑定这个pvc
...
![img](https://filescdn.proginn.com/d57b7fc67223247697f0c9ec6f0a1f9e/9b6ed439f812f3eb0e8405a08a57af0a.webp)
...
![img](https://filescdn.proginn.com/c7eefd5677dd610cbb5df6282c744be0/5ce182885dcced176020397016ec8a4e.webp)